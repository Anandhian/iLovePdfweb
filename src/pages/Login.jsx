...
const Login = () => {
  ...
  const socialBox =
    "flex items-center gap-2 border rounded-lg px-3 py-2 w-32 hover:shadow-md cursor-pointer transition";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-md flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8 md:p-10 bg-gray-50">
          ...
          {/* Social Logins */}
          <div className="flex flex-row flex-wrap gap-5 mb-6 justify-center">
            ...
            <div className={`${socialBox} border-red-500`}>
              ...
              <p className="text-sm text-gray-700 font-medium">Google</p>
            </div>

            <div className={socialBox}>
              <img src={sso} alt="SSO" className="w-6 h-6" />
              <p className="text-sm text-gray-700 font-medium">SSO</p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md space-y-4 mb-6">
            ...
            <p className="text-sm text-red-500 text-center cursor-pointer hover:underline">
              Forgot Password?
            </p>
          </div>
          ...
          <div className="mt-6 flex gap-2 text-sm text-gray-600 text-center">
            ...
            <p className="text-red-500 underline cursor-pointer hover:underline">Create account</p>
          </div>
        </div>
